...
import { Clock, PauseCircleIcon, Play, PlayCircleIcon } from "lucide-react";
...
const AlbumPage = () => {
    ...
    const {playAlbum,isPlaying,currentSong,togglePlay} = usePlayerStore();

    const handleAlbum =(index:number)=>{
    ...
    const handlePlayAlbum =()=>{
        ...
        else{playAlbum(currentAlbum.songs,0)};//start it from begining
    }
            ...
            <div className="relative min-h-full">
                ...
                <div className="relative z-10">
                    ...
                    <div className="bg-black/30 backdrop-blur-sm">
                        <div className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-10 py-2 text-sm text-zinc-400 border-white/15 border-b">
                           <div>#</div>
                           <div>Title</div>
                        ...
                        <div className="px-6 ">
                            <div className="py-4 space-y-2">
                                {currentAlbum?.songs.map((song,i)=>{
                                    ...
                                    return (
                                    <div className="grid grid-cols-[16px_4fr_2fr_1fr] gap-4 px-4 py-2 text-sm text-zinc-400 hover:bg-white/10 rounded-md group cursor-pointer"
                                     key={song._id.toString()} onClick={() => handleAlbum(i)}>
                                        ...
                                        <div className="flex items-center">{formatDur(song.duration)}</div>
                                    </div>
                                )})}
                            </div>
                        </div>
